...
"color:  rgb(0, 0, 0);")
        ...
        self.gridLayout_3.addWidget(self.total_symbols, 5, 0, 1, 1)
        ...
        self.configuredSymbolsScrollAreaWidget.setGeometry(QRect(0, 0, 470, 446))
...
"margin-right:50%;")
        ...
        self.min_delta_perc_input = QLineEdit(self.frame1)
        ...
        self.tf_input = QComboBox(self.frame1)
        ...
        self.fast_ema_period_input = QLineEdit(self.frame1)
        ...
        self.max_mart_depth_lbl = QLabel(self.frame1)
        ...
        self.symbol_input = QLineEdit(self.frame1)
        ...
        self.header_3 = QLabel(self.frame1)
        ...
        self.deal_deposit_lbl = QLabel(self.frame1)
        ...
        self.gridLayout_3.addWidget(self.frame1, 3, 2, 2, 1)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1197, 23))
