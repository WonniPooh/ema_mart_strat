...
"margin-right:50%;")
        ...
        self.update_btc_price_btn = QPushButton(self.frame)
        ...
        self.current_btc_price_lbl = QLabel(self.frame)
        ...
        self.max_simultaneous_deals_btn = QPushButton(self.frame)
        ...
        self.btc_stop_short_input = QLineEdit(self.frame)
        ...
        self.max_simultaneous_deals_lbl = QLabel(self.frame)
        ...
        self.max_simultaneous_deals_input = QLineEdit(self.frame)
        ...
        self.gridLayout_3.addWidget(self.frame1, 4, 3, 1, 1)
        ...
        self.tf_lbl = QLabel(self.frame2)
        self.tf_lbl.setObjectName(u"tf_lbl")

        self.gridLayout.addWidget(self.tf_lbl, 3, 0, 1, 1)

        self.direction_lbl = QLabel(self.frame2)
        self.direction_lbl.setObjectName(u"direction_lbl")

        self.gridLayout.addWidget(self.direction_lbl, 7, 0, 1, 1)

        self.slow_ema_period_input = QLineEdit(self.frame2)
        self.slow_ema_period_input.setObjectName(u"slow_ema_period_input")

        self.gridLayout.addWidget(self.slow_ema_period_input, 8, 1, 1, 1)

        self.leverage_input = QLineEdit(self.frame2)
        self.leverage_input.setObjectName(u"leverage_input")

        self.gridLayout.addWidget(self.leverage_input, 4, 1, 1, 1)

        self.deal_deposit_input = QLineEdit(self.frame2)
        self.deal_deposit_input.setObjectName(u"deal_deposit_input")

        self.gridLayout.addWidget(self.deal_deposit_input, 5, 1, 1, 1)

        self.margin_type_input = QComboBox(self.frame2)
        self.margin_type_input.addItem("")
        self.margin_type_input.addItem("")
        self.margin_type_input.setObjectName(u"margin_type_input")

        self.gridLayout.addWidget(self.margin_type_input, 6, 1, 1, 1)

        self.max_mart_depth_lbl = QLabel(self.frame2)
        self.max_mart_depth_lbl.setObjectName(u"max_mart_depth_lbl")
        self.max_mart_depth_lbl.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.max_mart_depth_lbl, 10, 0, 1, 1)

        self.mart_coef_lbl = QLabel(self.frame2)
        self.mart_coef_lbl.setObjectName(u"mart_coef_lbl")

        self.gridLayout.addWidget(self.mart_coef_lbl, 11, 0, 1, 1)

        self.min_delta_perc_lbl = QLabel(self.frame2)
        self.min_delta_perc_lbl.setObjectName(u"min_delta_perc_lbl")

        self.gridLayout.addWidget(self.min_delta_perc_lbl, 13, 0, 1, 1)

        self.min_delta_perc_input = QLineEdit(self.frame2)
        self.min_delta_perc_input.setObjectName(u"min_delta_perc_input")

        self.gridLayout.addWidget(self.min_delta_perc_input, 13, 1, 1, 1)

        self.header_3 = QLabel(self.frame2)
        ...
        self.margin_type_lbl = QLabel(self.frame2)
        self.margin_type_lbl.setObjectName(u"margin_type_lbl")

        self.gridLayout.addWidget(self.margin_type_lbl, 6, 0, 1, 1)

        self.symbol_input = QLineEdit(self.frame2)
        ...
        self.fast_ema_period_input = QLineEdit(self.frame2)
        self.fast_ema_period_input.setObjectName(u"fast_ema_period_input")

        self.gridLayout.addWidget(self.fast_ema_period_input, 9, 1, 1, 1)

        self.slow_ema_period_lbl = QLabel(self.frame2)
        self.slow_ema_period_lbl.setObjectName(u"slow_ema_period_lbl")
        self.slow_ema_period_lbl.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.slow_ema_period_lbl, 8, 0, 1, 1)

        self.leverage_lbl = QLabel(self.frame2)
        self.leverage_lbl.setObjectName(u"leverage_lbl")

        self.gridLayout.addWidget(self.leverage_lbl, 4, 0, 1, 1)

        self.pause_bars_num_lbl = QLabel(self.frame2)
        self.pause_bars_num_lbl.setObjectName(u"pause_bars_num_lbl")

        self.gridLayout.addWidget(self.pause_bars_num_lbl, 12, 0, 1, 1)

        self.tf_input = QComboBox(self.frame2)
        ...
        self.max_mart_depth_input = QLineEdit(self.frame2)
        self.max_mart_depth_input.setObjectName(u"max_mart_depth_input")

        self.gridLayout.addWidget(self.max_mart_depth_input, 10, 1, 1, 1)

        self.pause_bars_num_input = QLineEdit(self.frame2)
        self.pause_bars_num_input.setObjectName(u"pause_bars_num_input")

        self.gridLayout.addWidget(self.pause_bars_num_input, 12, 1, 1, 1)

        self.asset_lbl = QLabel(self.frame2)
        self.asset_lbl.setObjectName(u"asset_lbl")

        self.gridLayout.addWidget(self.asset_lbl, 2, 0, 1, 1)

        self.mart_coef_input = QLineEdit(self.frame2)
        self.mart_coef_input.setObjectName(u"mart_coef_input")

        self.gridLayout.addWidget(self.mart_coef_input, 11, 1, 1, 1)

        self.deal_deposit_lbl = QLabel(self.frame2)
        self.deal_deposit_lbl.setObjectName(u"deal_deposit_lbl")

        self.gridLayout.addWidget(self.deal_deposit_lbl, 5, 0, 1, 1)

        self.allowed_direction_input = QComboBox(self.frame2)
        self.allowed_direction_input.addItem("")
        self.allowed_direction_input.addItem("")
        self.allowed_direction_input.addItem("")
        self.allowed_direction_input.setObjectName(u"allowed_direction_input")

        self.gridLayout.addWidget(self.allowed_direction_input, 7, 1, 1, 1)

        self.fast_ema_period_lbl = QLabel(self.frame2)
        self.fast_ema_period_lbl.setObjectName(u"fast_ema_period_lbl")
        self.fast_ema_period_lbl.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.fast_ema_period_lbl, 9, 0, 1, 1)

        self.gridLayout.setColumnStretch(0, 3)

        self.gridLayout_3.addWidget(self.frame2, 3, 2, 2, 1)
        ...
        self.verticalLayout_3.addWidget(self.add_asset_cfg_btn)
        ...
        self.gridLayout_3.addWidget(self.configuredSymbolsScrollArea, 3, 0, 2, 2)
